...
class User(AbstractUser):
    ...
    altEmail = models.EmailField(
        blank=True, null=True, help_text="personal Email apart from the company email "
    )
    ...
    job_tittle = models.CharField(
        max_length=200, blank=True, null=True, choices=Job_tittle
    )
    date_joined = models.DateField(
        blank=True, null=True, help_text="The date the employee joined the organisation"
    )
